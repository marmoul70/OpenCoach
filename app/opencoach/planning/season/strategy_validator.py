...
from opencoach.planning.season.planning_input import SeasonPlanningInput
from opencoach.planning.season.strategy_proposal import SeasonStrategyProposal
