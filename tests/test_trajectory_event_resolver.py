...
def test_no_event_keeps_normal_progression() -> None:
    ...
    assert result.load_adjustment is LoadAdjustment.MAINTAIN
    assert (
...
def test_strongest_load_adjustment_wins() -> None:
    ...
    assert result.load_adjustment is LoadAdjustment.SUSPEND
...
def test_athlete_imposed_event_marks_schedule_as_constrained() -> None:
    ...
    assert result.athlete_schedule_constrained is True
